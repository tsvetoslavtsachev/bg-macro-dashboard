...
def test_context_stays_compact_like_the_china_model(context):
    ...
    на 18 000. Мандат №48 добавя котвения блок под инфлационната таблица и ДВЕ
    нови бележки за качеството (двата гласа + усещаната инфлация) → 22 000.
    Духът е СЪЩИЯТ: тревога, не бюджет — числото е там, за да
