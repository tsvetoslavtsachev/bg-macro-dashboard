...
def cmd_briefing(args):
    ...
    # Машинният api export (мандат ORGANISM-v1, bg огледалото на jp Ф1) се
    # ражда СЛЕД журнала — executive_summary цитира записания PIT ред, не
    # втора сметка. Ражда се ЗАЕДНО с другите повърхности (мандат №52) и се
    # сервира от Pages (`output/` е артефактът).
